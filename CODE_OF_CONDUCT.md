...
사건이 발생한 경우 이를 즉시 신고하는 것이 중요합니다. 잠재적인 위반 행위를 신고하려면 **<!-- TODO: 회사 신고 접수 메일 주소 -->**로 메일을 보내주세요. 저장소 이슈로는 올리지 마세요 — 이슈는 누구나 볼 수 있습니다.

신고 대상이 신고를 접수하는 사람 본인이거나 메일로 알리기 어려운 사정이 있다면 [GitHub에 직접 신고](https://github.com/contact/report-abuse)할 수 있습니다.
