...
export const SunIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    ...
    />
    <path
      d="M8 0.5V2.5M8 13.5V15.5M15.5 8H13.5M2.5 8H0.5M13.199 2.801L11.785 4.215M4.215 11.785L2.801 13.199M13.199 13.199L11.785 11.785M4.215 4.215L2.801 2.801"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const MoonIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M14 9.093A6 6 0 1 1 6.907 2 4.5 4.5 0 0 0 14 9.093Z"
      stroke="currentColor"
      strokeWidth="1.3"
      strokeLinejoin="round"
      fill="none"
